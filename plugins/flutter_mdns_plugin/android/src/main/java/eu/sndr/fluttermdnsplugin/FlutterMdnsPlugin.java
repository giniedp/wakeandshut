...
public class FlutterMdnsPlugin implements MethodCallHandler {
   ...
   * The map can be interpreted by the StandardMessageCodec of Flutter and makes
   * sending data back and forth simpler.
   * 
   * @param info The ServiceInfo to convert
   * @return The map that can be interpreted by Flutter and sent back on an
   *         EventChannel
   */
